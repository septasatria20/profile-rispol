...
export default function Home({ bidangs, prokers, news, heroImage, sliderImages = [], sliderTitles = [], youtubeLink, mentoringImage }) {
    ...
    return (
        <div className="min-h-screen font-sans text-slate-800 bg-slate-50 selection:bg-blue-200 animate-fade-in overflow-hidden">
            <Head>
                <title>Beranda | Kerohanian Islam Politeknik Negeri Malang</title>
                ...
                <meta property="og:title" content="Beranda | Kerohanian Islam Politeknik Negeri Malang" />
                ...
                <meta property="twitter:title" content="Beranda | Kerohanian Islam Politeknik Negeri Malang" />
